...
public class NativeShare : MonoBehaviour
{
    ...
    public string ScreenshotName; //Nombre de la imagen que se envia, y debe finalizar con ".png"
    public string ShareMessage; //Mensaje predeterminado
    private string subject, url; //Para iOS
    ...
    //Ejecuta la captura de pantalla y el compartir
    public void Share()
    {
